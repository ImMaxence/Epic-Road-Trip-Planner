...
var base_url = "http://localhost:8080/api/eat/get"

describe("sleep", function () {
    it('get sleep', (done) => {
        axios.post('http://localhost:8080/api/users/register', {
            username: "testEat",
            email: "test.eat@example.com",
            password: "password123"
        })
        .then(response => {
            axios.get('http://localhost:8080/api/eat/get?latitude=43.455198&longitude=5.479170',{
                headers: {
