...
exports.drinkGet = async (req, res) => {
    ...
    try {
        ...
        // {"distance_max": "100", "date_min":"08/04/2024", "date_max":"18/04/2024"}
        console.log(condition)
        const conditionParams = encodeURIComponent(JSON.stringify(condition));
        const apiUrl = `${process.env.ENDPOINT_API_PYTHON}api/drink?latitude=${latitude}&longitude=${longitude}&condition=${conditionParams}`;
        console.log(apiUrl)
